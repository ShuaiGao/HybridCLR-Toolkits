...
using HybridCLR.Editor.ThirdPart;
...
*/
        ...
        private void InstallOrUpgradeGui()
        {
            ...
            m_bEnableHuatuo = EditorGUILayout.ToggleLeft("是否启用HybridCLR", bEnableHuatuo);
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label($"HybridCLR路径:", m_styleNormalFont, GUILayout.Width(85));
            ...
            {
                var cachePath = EditorUtility.OpenFolderPanel("请选择HybridCLR路径", HTEditorConfig.Instance.HuatuoPath, "");
            ...
            if (installVersion.HuatuoTag?.Length > 0)
            {
                ...
                {
                    strMsg = $"HybridCLR: {installVersion.HuatuoTag}\t";
                }
            ...
            {
                GUILayout.Label($"最新版本:\tHybridCLR: {recommend.huatuoTag}\tIL2CPP: {recommend.il2cppTag}", m_styleNormalFont);
            }
            else
            {
                GUILayout.Label($"最新版本:\tHybridCLR: {recommend.huatuoTag}\tIL2CPP: {recommend.il2cppBranch}-{recommend.il2cppTag}", m_styleNormalFont);
            }
