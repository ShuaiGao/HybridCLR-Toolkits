...
using HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Encryption;
#endif

using HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Core;
using HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Checksums;
using HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Zip.Compression;

namespace HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using HybridCLR.Editor.ThirdPart.ICSharpCode.SharpZipLib.Zip;
	/// 
	/// class MainClass
	/// {
